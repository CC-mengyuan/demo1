...
<HTML>
	...
	<form  name="Form2" action="${pageContext.request.contextPath}/userAdmin_findNameByAddr" method="post">
	   		请输入地址：<input type="text" name="addr"><br />
			 <input type="submit" value="地址模糊查询">  	
	</form>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user/list.jsp" method="post">
			...
			<!-- 请输入地址：<input type="text" name="addr"/>
