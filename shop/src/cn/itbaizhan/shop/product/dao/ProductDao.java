...
public class ProductDao extends HibernateDaoSupport {
	...
	/*========================== 按模糊地址查询用户==================================*/
	public List<Product> findNameByAddr1(String address) {
	
		address="%"+address+"%";
		String hql = "from Product where address like ?";
		List<Product> list = this.getHibernateTemplate().find(hql, address);
		if (list != null && list.size() > 0) {
			return list;
		}
		return null;
